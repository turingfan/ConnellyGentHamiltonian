...
set title "Runtimes of the Posa Algorithm on Hamiltonian Graphs, alpha = 0.5"
set xlabel 'gamma'
...
set terminal postscript
set title "Number of Dropped Hamiltonian Graphs for the Posa Algorithm, alpha = 0.5"
set xlabel 'gamma'
...
set terminal postscript
set title "Percentage of Dropped Hamiltonian Graphs for the Posa Algorithm, alpha = 0.5"
set xlabel 'gamma'
set ylabel 'Percentage of Dropped Graphs'
set output 'posa_hth_drop_ratio_a0.5.ps'
plot [:] [0:0.4] "posa_hth_drop_ratio_n20_a0.5.gp" with linespoints title "n=20", "posa_hth_drop_ratio_n22_a0.5.gp" with linespoints title "n=22", "posa_hth_drop_ratio_n24_a0.5.gp" with linespoints title "n=24", "posa_hth_drop_ratio_n26_a0.5.gp" with linespoints title "n=26", "posa_hth_drop_ratio_n28_a0.5.gp" with linespoints title "n=28", "posa_hth_drop_ratio_n30_a0.5.gp" with linespoints title "n=30", "posa_hth_drop_ratio_n32_a0.5.gp" with linespoints title "n=32", "posa_hth_drop_ratio_n34_a0.5.gp" with linespoints title "n=34", "posa_hth_drop_ratio_n36_a0.5.gp" with linespoints title "n=36", "posa_hth_drop_ratio_n38_a0.5.gp" with linespoints title "n=38"


set terminal postscript
set title "Runtimes of the Posa Algorithm on Hamiltonian Graphs, alpha = 1.0"
set xlabel 'gamma'
set ylabel 'Number of Rotations'
...
set terminal postscript
set title "Number of Dropped Hamiltonian Graphs for the Posa Algorithm, alpha = 1.0"
set xlabel 'gamma'
set ylabel 'Number of Dropped Graphs'
...
set terminal postscript
set title "Percentage of Dropped Hamiltonian Graphs for the Posa Algorithm, alpha = 1.0"
set xlabel 'gamma'
set ylabel 'Percentage of Dropped Graphs'
set output 'posa_hth_drop_ratio_a1.0.ps'
plot [:] [0:0.4] "posa_hth_drop_ratio_n20_a1.0.gp" with linespoints title "n=20", "posa_hth_drop_ratio_n22_a1.0.gp" with linespoints title "n=22", "posa_hth_drop_ratio_n24_a1.0.gp" with linespoints title "n=24", "posa_hth_drop_ratio_n26_a1.0.gp" with linespoints title "n=26", "posa_hth_drop_ratio_n28_a1.0.gp" with linespoints title "n=28", "posa_hth_drop_ratio_n30_a1.0.gp" with linespoints title "n=30", "posa_hth_drop_ratio_n32_a1.0.gp" with linespoints title "n=32", "posa_hth_drop_ratio_n34_a1.0.gp" with linespoints title "n=34", "posa_hth_drop_ratio_n36_a1.0.gp" with linespoints title "n=36", "posa_hth_drop_ratio_n38_a1.0.gp" with linespoints title "n=38"


set terminal postscript
set title "Runtimes of the Posa Algorithm on Hamiltonian Graphs, alpha = 1.5"
set xlabel 'gamma'
set ylabel 'Number of Rotations'
...
set terminal postscript
set title "Number of Dropped Hamiltonian Graphs for the Posa Algorithm, alpha = 1.5"
set xlabel 'gamma'
set ylabel 'Number of Dropped Graphs'
