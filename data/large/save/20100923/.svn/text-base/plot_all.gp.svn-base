...
set key top left
plot 'a0.5.n109.p' with linespoints title 'n=109', 'a0.5.n130.p' with linespoints title 'n=130', 'a0.5.n156.p' with linespoints title 'n=156', 'a0.5.n187.p' with linespoints title 'n=187', 'a0.5.n224.p' with linespoints title 'n=224', 'a0.5.n268.p' with linespoints title 'n=268', 'a0.5.n321.p' with linespoints title 'n=321', 'a0.5.n385.p' with linespoints title 'n=385', 'a0.5.n462.p' with linespoints title 'n=462', 'a0.5.n554.p' with linespoints title 'n=554', 'a0.5.n64.p' with linespoints title 'n=64', 'a0.5.n664.p' with linespoints title 'n=664', 'a0.5.n76.p' with linespoints title 'n=76', 'a0.5.n796.p' with linespoints title 'n=796', 'a0.5.n91.p' with linespoints title 'n=91' 
set term postscript
set output 'a0.5.p.ps'
replot
set term x11
